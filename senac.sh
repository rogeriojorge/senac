...
maxiterations=3;      #max number of iterations for fit
...
maxm=2;                  #Maximum poloidal Fourier mode m to output to VMEC
maxn=3;                  #Maximum toroidal Fourier mode n to output to VMEC
maxRecursTheta=15;       #Theta resolution in numerical integration in Mercier to VMEC
maxRecursPhi=50;        #Phi resolution in numerical integration
#======PLOTTING PARAMETERS=====
