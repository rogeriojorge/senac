...
nphiM=35;                #resolution in phi for fit and Mercier's coordinates
maxiterations=5000;      #max number of iterations for fit
...
deltalmin=4.99;         #minimum deltal to help fit
...
#======PLOTTING PARAMETERS=====
nPlotTheta=120;           #number of interpolating points in theta
nPlotPhi=250;            #number of interpolating points in phi
plotPointsFig=50;        #plotpoints for 3D figure
maxRecursPlot=3;         #max recursion for 3D figure
